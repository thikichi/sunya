...
<div id="Tab3Child">
  ...
  <div id="Tab3Child-1">
    ...
    <div class="admintab-formparts-wrapper">
      <input type="text" name="sunya_options[cpt][news][label]" value="">
    </div>
    ...
    <div class="admintab-formparts-wrapper">
      <input type="text" name="sunya_options[cpt][news][slug]" value="">
    </div>

    <h3 class="admintab-subttl">サポートする属性</h3>
    <p class="admintab-descrip">新着情報でサポートする属性（タイトルやアイキャッチ画像などの部品）を選択・表示することができます。</p>
    <div class="admintab-formparts-wrapper">
      <label><input type="checkbox" name="sunya_options[cpt][news][supports][title]" value="1" checked>タイトル</label>
      <label><input type="checkbox" name="sunya_options[cpt][news][supports][editor]" value="1" checked>エディター</label>
      <label><input type="checkbox" name="sunya_options[cpt][news][supports][thumbnail]" value="1" checked>アイキャッチ画像</label>
      <label><input type="checkbox" name="sunya_options[cpt][news][supports][revisions]" value="1" checked>リビジョン</label>
    </div>
